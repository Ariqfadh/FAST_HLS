; ModuleID = 'C:/Users/ariqf/Kuliah/KP/Workspace/fast_ip/fast_ip/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_fast_ip_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %src_axi, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %dst_axi, i32 %img_width, i32 %img_height, i8 zeroext %threshold) local_unnamed_addr #0 {
entry:
  %src_axi_copy.data = alloca i32, align 512
  %src_axi_copy.keep = alloca i4, align 512
  %src_axi_copy.strb = alloca i4, align 512
  %src_axi_copy.last = alloca i1, align 512
  %dst_axi_copy.data = alloca i32, align 512
  %dst_axi_copy.keep = alloca i4, align 512
  %dst_axi_copy.strb = alloca i4, align 512
  %dst_axi_copy.last = alloca i1, align 512
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nonnull %src_axi, i32* nonnull align 512 %src_axi_copy.data, i4* nonnull align 512 %src_axi_copy.keep, i4* nonnull align 512 %src_axi_copy.strb, i1* nonnull align 512 %src_axi_copy.last, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nonnull %dst_axi, i32* nonnull align 512 %dst_axi_copy.data, i4* nonnull align 512 %dst_axi_copy.keep, i4* nonnull align 512 %dst_axi_copy.strb, i1* nonnull align 512 %dst_axi_copy.last)
  call void @apatb_fast_ip_hw(i32* %src_axi_copy.data, i4* %src_axi_copy.keep, i4* %src_axi_copy.strb, i1* %src_axi_copy.last, i32* %dst_axi_copy.data, i4* %dst_axi_copy.keep, i4* %dst_axi_copy.strb, i1* %dst_axi_copy.last, i32 %img_width, i32 %img_height, i8 %threshold)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %src_axi, i32* %src_axi_copy.data, i4* %src_axi_copy.keep, i4* %src_axi_copy.strb, i1* %src_axi_copy.last, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %dst_axi, i32* %dst_axi_copy.data, i4* %dst_axi_copy.keep, i4* %dst_axi_copy.strb, i1* %dst_axi_copy.last)
  ret void
}
...
declare void @apatb_fast_ip_hw(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, i32, i32, i8)
...
declare void @fast_ip_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, i32, i32, i8 zeroext)

define void @fast_ip_hw_stub_wrapper(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, i32, i32, i8) #5 {
entry:
  ...
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %12, i32* %0, i4* %1, i4* %2, i1* %3, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %14, i32* %4, i4* %5, i4* %6, i1* %7)
  call void @fast_ip_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %12, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %14, i32 %8, i32 %9, i8 %10)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %12, i32* %0, i4* %1, i4* %2, i1* %3, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %14, i32* %4, i4* %5, i4* %6, i1* %7)
