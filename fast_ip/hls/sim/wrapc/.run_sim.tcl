...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fast_ip.autotvin.dat"
	set constFileTvOut       "fast_ip.autotvout.dat"
	set constFileHdlTvIn     "fast_ip.autohdltvin.dat"
	set constFileHdlTvOut    "fast_ip.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
