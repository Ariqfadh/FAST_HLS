...
// ==============================================================
`timescale 1ns/1ps
module fast_ip_CONTROL_BUS_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER               = 6'h08,
    ADDR_ISR               = 6'h0c,
    ADDR_IMG_WIDTH_DATA_0  = 6'h10,
    ADDR_IMG_WIDTH_CTRL    = 6'h14,
    ADDR_IMG_HEIGHT_DATA_0 = 6'h18,
    ADDR_IMG_HEIGHT_CTRL   = 6'h1c,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_IMG_HEIGHT_DATA_0: begin
                    rdata <= int_img_height[31:0];
                end
...
assign img_height        = int_img_height;
...
always @(posedge ACLK) begin
    if (ARESET)
        int_img_height[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_IMG_HEIGHT_DATA_0)
            int_img_height[31:0] <= (WDATA[31:0] & wmask) | (int_img_height[31:0] & ~wmask);
    end
end
