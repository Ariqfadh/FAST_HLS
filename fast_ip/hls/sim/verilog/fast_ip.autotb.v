...
`define AUTOTB_DUT      fast_ip
`define AUTOTB_DUT_INST AESL_inst_fast_ip
`define AUTOTB_TOP      apatb_fast_ip_top
`define AUTOTB_LAT_RESULT_FILE "fast_ip.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "fast_ip.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_fast_ip_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_src_axi_V_data_V 1
`define AESL_DEPTH_src_axi_V_keep_V 1
`define AESL_DEPTH_src_axi_V_strb_V 1
`define AESL_DEPTH_src_axi_V_last_V 1
...
`define AESL_DEPTH_img_height 1
...
`define AUTOTB_TVIN_src_axi_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.fast_ip.autotvin_src_axi_V_data_V.dat"
`define AUTOTB_TVIN_src_axi_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.fast_ip.autotvin_src_axi_V_keep_V.dat"
`define AUTOTB_TVIN_src_axi_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.fast_ip.autotvin_src_axi_V_strb_V.dat"
`define AUTOTB_TVIN_src_axi_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.fast_ip.autotvin_src_axi_V_last_V.dat"
`define AUTOTB_TVIN_img_width_out_wrapc  "../tv/rtldatafile/rtl.fast_ip.autotvin_img_width.dat"
`define AUTOTB_TVIN_img_height_out_wrapc  "../tv/rtldatafile/rtl.fast_ip.autotvin_img_height.dat"
`define AUTOTB_TVIN_threshold_out_wrapc  "../tv/rtldatafile/rtl.fast_ip.autotvin_threshold.dat"
...
`define AUTOTB_TVOUT_dst_axi_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.fast_ip.autotvout_dst_axi_V_data_V.dat"
`define AUTOTB_TVOUT_dst_axi_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.fast_ip.autotvout_dst_axi_V_keep_V.dat"
`define AUTOTB_TVOUT_dst_axi_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.fast_ip.autotvout_dst_axi_V_strb_V.dat"
`define AUTOTB_TVOUT_dst_axi_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.fast_ip.autotvout_dst_axi_V_last_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_dst_axi_V_data_V = 307200;
parameter LENGTH_dst_axi_V_keep_V = 307200;
parameter LENGTH_dst_axi_V_last_V = 307200;
parameter LENGTH_dst_axi_V_strb_V = 307200;
parameter LENGTH_img_height = 1;
parameter LENGTH_img_width = 1;
parameter LENGTH_src_axi_V_data_V = 307200;
parameter LENGTH_src_axi_V_keep_V = 307200;
parameter LENGTH_src_axi_V_last_V = 307200;
parameter LENGTH_src_axi_V_strb_V = 307200;
...
reg [31:0] ap_c_n_tvin_trans_num_src_axi_V_data_V;

reg src_axi_ready_reg; // for self-sync

wire src_axi_ready;
wire src_axi_done;
wire [31:0] src_axi_transaction;
wire axi_s_src_axi_TVALID;
wire axi_s_src_axi_TREADY;

AESL_axi_s_src_axi AESL_AXI_S_src_axi(
    .clk(AESL_clock),
    .reset(AESL_reset),
    .TRAN_src_axi_TDATA(src_axi_TDATA),
    .TRAN_src_axi_TKEEP(src_axi_TKEEP),
    .TRAN_src_axi_TSTRB(src_axi_TSTRB),
    .TRAN_src_axi_TLAST(src_axi_TLAST),
    .TRAN_src_axi_TVALID(axi_s_src_axi_TVALID),
    .TRAN_src_axi_TREADY(axi_s_src_axi_TREADY),
    .ready(src_axi_ready),
    .done(src_axi_done),
    .transaction(src_axi_transaction));

assign src_axi_ready = src_axi_ready_reg | ready_initial;
assign src_axi_done = 0;

assign src_axi_TVALID = axi_s_src_axi_TVALID;

assign axi_s_src_axi_TREADY = src_axi_TREADY;
...
reg end_src_axi_V_data_V;
reg [31:0] size_src_axi_V_data_V;
reg [31:0] size_src_axi_V_data_V_backup;
reg end_src_axi_V_keep_V;
reg [31:0] size_src_axi_V_keep_V;
reg [31:0] size_src_axi_V_keep_V_backup;
reg end_src_axi_V_strb_V;
reg [31:0] size_src_axi_V_strb_V;
reg [31:0] size_src_axi_V_strb_V_backup;
reg end_src_axi_V_last_V;
reg [31:0] size_src_axi_V_last_V;
reg [31:0] size_src_axi_V_last_V_backup;
reg end_img_width;
reg [31:0] size_img_width;
reg [31:0] size_img_width_backup;
reg end_img_height;
reg [31:0] size_img_height;
reg [31:0] size_img_height_backup;
reg end_threshold;
...
begin
    ...
    initial begin : proc_gen_axis_internal_ready_src_axi
        src_axi_ready_reg = 0;
        @ (posedge ready_initial);
        forever begin
            @ (ap_c_n_tvin_trans_num_src_axi_V_data_V or src_axi_transaction);
            if (ap_c_n_tvin_trans_num_src_axi_V_data_V > src_axi_transaction) begin
                src_axi_ready_reg = 1;
            end else begin
                src_axi_ready_reg = 0;
            end
    ...
    `define STREAM_SIZE_IN_src_axi_V_data_V "../tv/stream_size/stream_size_in_src_axi_V_data_V.dat"
    
    initial begin : gen_ap_c_n_tvin_trans_num_src_axi_V_data_V
        integer fp_src_axi_V_data_V;
        reg [127:0] token_src_axi_V_data_V;
        integer ret;
        
        ap_c_n_tvin_trans_num_src_axi_V_data_V = 0;
        end_src_axi_V_data_V = 0;
        wait (AESL_reset === 1);
        
        fp_src_axi_V_data_V = $fopen(`STREAM_SIZE_IN_src_axi_V_data_V, "r");
        if(fp_src_axi_V_data_V == 0) begin
            $display("Failed to open file \"%s\"!", `STREAM_SIZE_IN_src_axi_V_data_V);
            $finish;
        end
        read_token(fp_src_axi_V_data_V, token_src_axi_V_data_V); // should be [[[runtime]]]
        if (token_src_axi_V_data_V != "[[[runtime]]]") begin
            $display("ERROR: token_src_axi_V_data_V != \"[[[runtime]]]\"");
            $finish;
        end
        size_src_axi_V_data_V = 0;
        size_src_axi_V_data_V_backup = 0;
        while (size_src_axi_V_data_V == 0 && end_src_axi_V_data_V == 0) begin
            ap_c_n_tvin_trans_num_src_axi_V_data_V = ap_c_n_tvin_trans_num_src_axi_V_data_V + 1;
            read_token(fp_src_axi_V_data_V, token_src_axi_V_data_V); // should be [[transaction]] or [[[/runtime]]]
            if (token_src_axi_V_data_V == "[[transaction]]") begin
                read_token(fp_src_axi_V_data_V, token_src_axi_V_data_V); // should be transaction number
                read_token(fp_src_axi_V_data_V, token_src_axi_V_data_V); // should be size for hls::stream
                ret = $sscanf(token_src_axi_V_data_V, "%d", size_src_axi_V_data_V);
                if (size_src_axi_V_data_V > 0) begin
                    size_src_axi_V_data_V_backup = size_src_axi_V_data_V;
                end
                read_token(fp_src_axi_V_data_V, token_src_axi_V_data_V); // should be [[/transaction]]
            end else if (token_src_axi_V_data_V == "[[[/runtime]]]") begin
                $fclose(fp_src_axi_V_data_V);
                end_src_axi_V_data_V = 1;
            end else begin
                $display("ERROR: unknown token_src_axi_V_data_V");
                $finish;
            end
        end
        forever begin
            @ (posedge AESL_clock);
            if (end_src_axi_V_data_V == 0) begin
                if ((src_axi_TREADY & src_axi_TVALID) == 1) begin
                    if (size_src_axi_V_data_V > 0) begin
                        size_src_axi_V_data_V = size_src_axi_V_data_V - 1;
                        while (size_src_axi_V_data_V == 0 && end_src_axi_V_data_V == 0) begin
                            ap_c_n_tvin_trans_num_src_axi_V_data_V = ap_c_n_tvin_trans_num_src_axi_V_data_V + 1;
                            read_token(fp_src_axi_V_data_V, token_src_axi_V_data_V); // should be [[transaction]] or [[[/runtime]]]
                            if (token_src_axi_V_data_V == "[[transaction]]") begin
                                ...
                                size_src_axi_V_data_V = size_src_axi_V_data_V_backup;
                                $fclose(fp_src_axi_V_data_V);
                                end_src_axi_V_data_V = 1;
                            end else begin
                                $display("ERROR: unknown token_src_axi_V_data_V");
