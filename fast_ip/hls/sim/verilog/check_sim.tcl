...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fast_ip.autotvin_src_axi_V_data_V.dat"
         "c.fast_ip.autotvin_src_axi_V_keep_V.dat"
         "c.fast_ip.autotvin_src_axi_V_strb_V.dat"
         "c.fast_ip.autotvin_src_axi_V_last_V.dat"
         "c.fast_ip.autotvin_img_width.dat"
         "c.fast_ip.autotvin_img_height.dat"
         "c.fast_ip.autotvin_threshold.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fast_ip.autotvout_dst_axi_V_data_V.dat"
         "rtl.fast_ip.autotvout_dst_axi_V_keep_V.dat"
         "rtl.fast_ip.autotvout_dst_axi_V_strb_V.dat"
         "rtl.fast_ip.autotvout_dst_axi_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
