...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("src_axi_TDATA", 32, hls_in, 0, "axis", "in_data", 1),
	Port_Property("src_axi_TVALID", 1, hls_in, 3, "axis", "in_vld", 1),
	Port_Property("src_axi_TREADY", 1, hls_out, 3, "axis", "in_acc", 1),
	Port_Property("src_axi_TKEEP", 4, hls_in, 1, "axis", "in_data", 1),
	Port_Property("src_axi_TSTRB", 4, hls_in, 2, "axis", "in_data", 1),
	Port_Property("src_axi_TLAST", 1, hls_in, 3, "axis", "in_data", 1),
	Port_Property("dst_axi_TDATA", 32, hls_out, 4, "axis", "out_data", 1),
	Port_Property("dst_axi_TVALID", 1, hls_out, 7, "axis", "out_vld", 1),
	Port_Property("dst_axi_TREADY", 1, hls_in, 7, "axis", "out_acc", 1),
	Port_Property("dst_axi_TKEEP", 4, hls_out, 5, "axis", "out_data", 1),
	Port_Property("dst_axi_TSTRB", 4, hls_out, 6, "axis", "out_data", 1),
	Port_Property("dst_axi_TLAST", 1, hls_out, 7, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "fast_ip";
