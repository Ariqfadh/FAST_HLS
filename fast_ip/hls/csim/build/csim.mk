...
HLS_SOURCES = ../../../../fast_ip_tb.cpp ../../../../fast_ip.cpp
...
$(ObjDir)/fast_ip_tb.o: ../../../../fast_ip_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../fast_ip_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/fast_ip_tb.d

$(ObjDir)/fast_ip.o: ../../../../fast_ip.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../fast_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/fast_ip.d
